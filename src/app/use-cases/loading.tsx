...
import { PageSkeleton, SkeletonLines, SkeletonPillRow } from "@/components/ui/skeletons";

export default function UseCasesLoading() {
  return (
    <PageSkeleton className="bg-transparent min-h-[100dvh]">
      <section className="pt-28 pb-0 bg-transparent">
        <SkeletonPillRow
          widths={[148, 128, 132, 148, 176]}
